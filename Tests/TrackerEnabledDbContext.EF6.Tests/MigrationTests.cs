...
using TrackerEnabledDbContext.EF6.Common.Tools;
...
namespace TrackerEnabledDbContext.EF6.Tests
{
    ...
    public class MigrationTests: PersistanceTests<TestTrackerContext>
    {
        ...
        private void InsertFakeLegacyLog()
        {
            ...
            Db.AuditLogDetails.Add(magnitudeLogDetail);
            Db.AuditLogDetails.Add(directionLogDetail);
            Db.AuditLogDetails.Add(subjectLogDetail);
