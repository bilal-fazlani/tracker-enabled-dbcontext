...
using TrackerEnabledDbContext.EF6.Common.Auditors;
...
namespace TrackerEnabledDbContext.EF6.Tests
{
    ...
    public class TrackerContextIntegrationTests : PersistanceTests<TestTrackerContext>
    {
        ...
        public async Task Can_skip_tracking_of_property()
        {
            ...
            Db.ModelWithSkipTrackings.Add(entity);
        ...
        public void Can_track_composite_keys()
        {
            ...
            Db.ModelWithCompositeKeys.Add(entity);
            Db.SaveChanges(userName);
        ...
        public async Task Can_get_logs_by_table_name()
        {
            ...
            IEnumerable<AuditLog> logs = Db.GetLogs("TrackerEnabledDbContext.Common.Tests.Models.NormalModel", model.Id)
        ...
        public async Task Can_get_all_logs()
        {
            ...
            IEnumerable<AuditLog> logs = Db.GetLogs("TrackerEnabledDbContext.Common.Tests.Models.NormalModel")
                .AssertCountIsNotZero("logs not found");
        ...
        public void Should_Not_Log_When_Value_Not_changed()
        {
            ...
            Db.TrackedModelWithMultipleProperties.Add(entity);
            Db.SaveChanges();
        ...
        public void Shoud_Not_Log_EmptyProperties_On_Deletions()
        {
            ...
            //act (delete)
            Db.TrackedModelWithMultipleProperties.Remove(entity);
            Db.SaveChanges();
