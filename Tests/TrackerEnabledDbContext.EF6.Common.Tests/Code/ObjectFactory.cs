...
namespace TrackerEnabledDbContext.EF6.Common.Tests.Code
{
    public class ObjectFactory<TContext> where TContext : ITestDbContext, new()
    {
        ...
        public TEntity Create<TEntity>(bool fill = true, bool save = false, ITestDbContext testDbContext = null) where TEntity : class
        {
