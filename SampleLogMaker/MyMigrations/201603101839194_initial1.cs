namespace SampleLogMaker.MyMigrations
{
    ...
    public partial class initial1 : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        ParentBlogId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Blogs", t => t.ParentBlogId, cascadeDelete: true)
                .Index(t => t.ParentBlogId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Comments", "ParentBlogId", "dbo.Blogs");
            ...
            DropIndex("dbo.Comments", new[] { "ParentBlogId" });
