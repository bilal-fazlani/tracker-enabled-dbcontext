...
namespace TrackerEnabledDbContext.EF6.Common.Configuration
{
    ...
    internal static class DbContextExtensions
    {
        ...
        public static IEnumerable<PropertyConfigurationKey> GetKeyNames(this DbContext context, Type entityType)
        {
            ...
            return entityMetadata.KeyProperties.Select(x => new PropertyConfigurationKey(x.Name, entityType.FullName));
        }
    }
}
